...
const Carousel = React.createClass({
    ...
    render() {
        ...
        return (
          <div className={[ 'slider', this.props.className || '' ].join(' ')} ref='slider' style={assign(this.getSliderStyles(), this.props.style || {})}>
            ...
            {(this.props.decorators && this.props.arrow) ?
    ...
    getMouseEvents() {
        ...
        return {
            ...
            onMouseMove(e) {
                ...
                self.props.touchingStatus('dragging')
            },
            onMouseUp(e) {
                if (!self.state.dragging) {
                    return
                ...
                self.handleSwipe(e)
                self.props.touchingStatus('dragged')
            },
            onMouseLeave(e) {
                if (!self.state.dragging) {
                    return
    ...
    handleSwipe(e) {
        ...
        if (this.touchObject.length > (this.state.slideWidth / this.props.slidesToShow) / 5) {
            if (this.touchObject.direction === 1) {
               ...
               // if (this.state.currentSlide + this.props.slidesToShow - 1 >= React.Children.count(this.props.children) - this.state.slidesToScroll ) {
        ...
        this.setState({ dragging: false }) //eslint-disable-line
    },
  ...
  // Action Methods
    ...
    nextSlide() {
        let self = this
      //  if ((this.state.currentSlide + this.state.slidesToScroll+this.props.slidesToShow-1) >= React.Children.count(this.props.children)) {
        ...
        this.props.indexCb(this.state.currentSlide + this.state.slidesToScroll)
  ...
  // Bootstrapping
    ...
    setInitialDimensions() {
        let self = this, slideWidth, frameHeight, slideHeight
    ...
    getListStyles() {
        ...
        let spacingOffset = this.props.cellSpacing * React.Children.count(this.props.children)
        return {
            position: 'relative',
            display: 'block',
            ...
            margin: this.props.vertical ? (this.props.cellSpacing / 2) * -1 + 'px 0px'
                                        : '0px ' + (this.props.cellSpacing / 2) * -1 +
            'px',
            padding: 0,
